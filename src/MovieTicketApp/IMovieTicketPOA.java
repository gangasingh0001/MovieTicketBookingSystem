 ...
 implements MovieTicketApp.IMovieTicketOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("exchangeTicket", new java.lang.Integer (10));
  }
  ...
  /**
       ...
       case 10:  // MovieTicketApp/IMovieTicket/exchangeTicket
       {
         String customerID = in.read_string ();
         String movieID = in.read_string ();
         String movieName = in.read_string ();
         ...
         String $result = null;
         $result = this.exchangeTicket (customerID, movieID, movieName, newMovieID, newMovieName);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }
